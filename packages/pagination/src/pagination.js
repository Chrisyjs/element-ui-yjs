...
export default {
  ...
  render(h) {
    ...
    const TEMPLATE_MAP = {
      ...
      pager: <pager jlb-ui={this.jlbUi} currentPage={ this.internalCurrentPage } pageCount={ this.internalPageCount } pagerCount={ this.pagerCount } on-change={ this.handleCurrentChange } disabled={ this.disabled }></pager>,
      next: <next></next>,
    ...
    Prev: {
      render(h) {
        return (
          <button
            type="button"
            class={ this.$parent.jlbUi ? 'btn-prev jlb-btn-prev' : 'btn-prev'}
    ...
    Next: {
      render(h) {
        return (
          <button
            type="button"
            class={ this.$parent.jlbUi ? 'btn-prev jlb-btn-next' : 'btn-next'}
      ...
      render(h) {
        return (
          <span class="el-pagination__sizes">
            ...
            {
              this.$parent.jlbUi ? <span>&nbsp;&nbsp;当前第 {this.$parent.internalCurrentPage} 页 / 共 {Math.ceil(this.$parent.total / this.$parent.internalPageSize)} 页</span> : ''
            }
          </span>
        );
      },
      ...
      render(h) {
        return (
          <span class="el-pagination__jump">
            { this.$parent.jlbUi ? '跳至' : this.t('el.pagination.goto') }
            <el-input
